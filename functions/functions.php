...
$get_products = "select * from products WHERE top='yes'";
                    ...
                    <div class='card h-100 '>
                        ...
                        <div class='card-body'>
                            <ul class='list-unstyled d-flex justify-content-between'>
                                <li>
                                    <i class='label label-danger'> $product_label</i>
                                </li>
                                <li class='text-muted text-right'>$product_price $product_psp_price</li>
                            </ul>
                            <a href='$pro_url' class='h2 text-decoration-none text-dark'>$pro_title</a>
                            <p class='card-text'>
                                $manufacturer_name
                            </p>
                            <p class='text-muted'>
                                <div class='row'>
                                    <div class='col-6'>
                                            <a class='btn btn-success' href='$pro_url'>View Details</a>
                                    </div>
                                    <div class='col-6'>
                                            <a class='btn btn-danger' href='$pro_url' >Add to Cart</a>
                                    </div>
